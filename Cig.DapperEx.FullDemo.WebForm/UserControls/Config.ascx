<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Config.ascx.cs" Inherits="WebForm.UserControls.Config" %>
<!--Config demo-->
<div id="config" class="config hidden-xs">
    <h4>设置<a href="javascript:void(0)" class="config-link closed"><i class="icon-settings"></i></a></h4>
